...
python3 -m verl.trainer.main_ppo \
    ...
    data.train_files=./data/to_critique/Qwen2.5-Math-1.5B-L-openr1-f3/to_critique.parquet \
    data.val_files=./data/to_critique/Qwen2.5-Math-1.5B-L-openr1-f3/to_critique.parquet \
    data.shuffle=False \
    ...
    trainer.default_local_dir=./checkpoints/gen_critique/Qwen2.5-7B-Instruct-to-Qwen2.5-Math-1.5B-L-openr1-f3-openr1-n8-step100-500 \
